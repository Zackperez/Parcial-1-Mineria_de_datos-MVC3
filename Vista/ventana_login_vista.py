...
class Ventana_Login_Vista():
    ...
    def decorar_ventana(self):
        ...
        self.btnGuardar_texto_escrito = tk.Button(self.root, text = "Iniciar sesión",width = 10, height = 1)
        self.btnGuardar_texto_escrito.pack(pady=10)

        self.btnRegistrar_Usuario = tk.Button(self.root, text = "Registrarse",width = 10, height = 1)
        self.btnRegistrar_Usuario.pack(pady=10)
